...
![book1](screenshots/77.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![book1](screenshots/38.png)
...
![book1](screenshots/39.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![book1](screenshots/88.png)
...
https://www.linkedin.com/posts/tim-obi-40688a3a7_dmibypravinmishra-agenticai-claudecode-activity-7482895556093124608-Tox6?utm_source=share&utm_medium=member_desktop&rcm=ACoAAGOencYBw8GQRmlEqrn_AHS24OqmBpkIlVs
