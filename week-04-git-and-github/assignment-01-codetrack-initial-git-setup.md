...
When I initialized git, it created a hidden folder called .git. This folder is the heart of Git, without it, Git cannot track your projects, commit your changes and so on.
